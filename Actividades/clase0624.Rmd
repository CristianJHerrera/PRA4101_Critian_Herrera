...
author: "Cristian Josué Herrera Rivera"
output:
  pdf_document:
    toc: true
    toc_depth: '3'
...
iris %>%
  ...
  group_by(Species) %>%
  summarize(
    promedio_relacion_petalo = mean(relacion_petalo),
    promedio_relacion_sepalo = mean(relacion_sepalo),
    n()
  ) %>%
